...
const MODULE_ID = "{fe8aba2a-498e-497f-8018-6866d5dbe206}";
...
function startup(data, reason) {
  getCategoryManager().addCategoryEntry("JavaScript global property",
                                        "identity", 
                                        MODULE_ID,
                                        true, true);
}
...
function shutdown(data, reason) {
  getCategoryManager().deleteCategoryEntry("JavScript global property", "identity", true);
}
